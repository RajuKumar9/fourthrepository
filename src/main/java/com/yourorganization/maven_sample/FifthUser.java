	 ...
	 WebDriver driver;
	  @Test
	    ...
	    {  
		 ...
		 System.setProperty("webdriver.chrome.driver","C:\\Users\\ASTR-34\\Desktophromedriver.exe");
		...
		//options.addArguments("--start-fullscreen");
	     ...
	     driver.findElement(By.xpath("//input[@class='bootbox-input bootbox-input-text form-control']")).sendKeys("trim2");
	     Thread.sleep(2000);
